...
class UserBookActivityServices(
    ...
    override fun getBooksByStatusInYear(
        ...
        booksRead.forEach {
            it.book.__averageRating = ratingRepository.findAverageRatingByBook(
                org.pentales.pentalesrest.models.entities.book.Book(
                    id = it.book.id
                )
            ) ?: 0.0
            it.book.__ratingCount =
                ratingRepository.countAllByBook(org.pentales.pentalesrest.models.entities.book.Book(id = it.book.id))
        }
